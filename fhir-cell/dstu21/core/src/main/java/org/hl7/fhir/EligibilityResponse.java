...
@javax.xml.bind.annotation.XmlRootElement(name="EligibilityResponse") 
    ...
    extends DomainResource
{
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EligibilityResponseBenefitBalance }
     * 
     * 
     */
    public List<EligibilityResponseBenefitBalance> getBenefitBalance() {
        if (benefitBalance == null) {
            benefitBalance = new ArrayList<EligibilityResponseBenefitBalance>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EligibilityResponseError }
     * 
     * 
     */
    public List<EligibilityResponseError> getError() {
        if (error == null) {
            error = new ArrayList<EligibilityResponseError>();
        }
        return this.error;
    }
