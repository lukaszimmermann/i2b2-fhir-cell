...
import edu.harvard.i2b2.oauth2.AccessToken;


/*
 * Will fetch Bundle and put it in the cache
 */
@Stateful
public class PatientBundleManager {
	...
	public void fetchPatientBundleThread(AccessToken tok, String pid) throws FhirServerException {
	...
	private void doFetch(AccessToken tok, String pid) throws FhirServerException {
