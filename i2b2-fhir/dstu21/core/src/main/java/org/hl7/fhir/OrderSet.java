 ...
 * 
 * <p>Java class for OrderSet complex type.
 * 
 ...
 *         &lt;element name="item" type="{http://hl7.org/fhir}OrderSet.Item" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "OrderSet", propOrder = {
    "identifier",
    "version",
    "moduleMetadata",
    "library",
...
@javax.xml.bind.annotation.XmlRootElement(name="OrderSet") 
    ...
    extends DomainResource
{
    ...
    protected List<OrderSetItem> item;
     ...
     * 
     */
    public List<OrderSetItem> getItem() {
        if (item == null) {
            item = new ArrayList<OrderSetItem>();
        }
        return this.item;
    }
