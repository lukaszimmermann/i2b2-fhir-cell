 ...
 * 
 * <p>Java class for ModuleDefinition.ValueSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ModuleDefinition.ValueSet">
 *   &lt;complexContent>
...
@XmlType(name = "ModuleDefinition.ValueSet", propOrder = {
    "name",
    "identifier",
    "version",
    "codeSystem"
})
@javax.xml.bind.annotation.XmlRootElement(name="ModuleDefinitionValueSet") 
public class ModuleDefinitionValueSet
    extends BackboneElement
{
    ...
    public List<String> getCodeSystem() {
        if (codeSystem == null) {
            codeSystem = new ArrayList<String>();
        }
