...
public abstract class Query {
	...
	abstract protected void init() throws QueryValueException, QueryParameterException, QueryException;
	...
	public Query(Class resourceClass, String rawParameter, String rawValue, Object object)
			throws QueryParameterException, QueryValueException, QueryException {
	...
	private void initalize(boolean flag) throws QueryParameterException, QueryValueException, QueryException {
	...
	abstract public boolean match(String resourceXml, Resource r, List<Resource> s, MetaResourceDb db)
	...
	private ArrayList<String> getValuesFromParameterPath(Resource r, String parPath, MetaResourceDb db,
			boolean explodeF) throws XQueryUtilException, NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		ArrayList<String> list = new ArrayList<String>();

		List<Object> objList = FhirUtil.getChildrenThruParPath(r, parPath+"/@value/string()", db);
		for (Object c : objList) {
			Class childClass=FhirUtil.getResourceClass((Resource)c);
		}
	...
	protected ArrayList<String> getListFromParameterPath(String xml, String parPath) throws XQueryUtilException {
		ArrayList<String> list = new ArrayList<String>();
	...
	public String toString() {
		return " [rawParameter=" + rawParameter + ", rawValue=" + rawValue + ", parameterPath=" + parameterPath
				+ ", resourceClass=" + resourceClass + ", modifier=" + modifier + ", parameter=" + parameter + ", type="
				+ type + ",";
	}
	...
	protected boolean textSearch(String xml, String searchText) throws XQueryUtilException {
		...
		for (String v : list) {
			if (this.getModifier().equals("exact")) {
				...
				v = v.toLowerCase().replaceAll("\\s+", " ").replaceAll("^\\s", "").replaceAll("\\s$", "");
