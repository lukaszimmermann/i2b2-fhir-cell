 ...
 *         &lt;element name="modalityList" type="{http://hl7.org/fhir}ImagingModality" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends DomainResource
{
    ...
    protected List<ImagingModality> modalityList;
     ...
     * 
     */
    public List<ImagingModality> getModalityList() {
        if (modalityList == null) {
            modalityList = new ArrayList<ImagingModality>();
        }
