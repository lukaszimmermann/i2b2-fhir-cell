 ...
 *         &lt;element name="clinicalStatus" type="{http://hl7.org/fhir}ConditionClinicalStatus"/>
 ...
 *         &lt;element name="dueTo" type="{http://hl7.org/fhir}Condition.DueTo" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="occurredFollowing" type="{http://hl7.org/fhir}Condition.OccurredFollowing" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends DomainResource
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dueTo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDueTo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<ConditionDueTo> getDueTo() {
        if (dueTo == null) {
            dueTo = new ArrayList<ConditionDueTo>();
        }
        return this.dueTo;
    }

    /**
     * Gets the value of the occurredFollowing property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the occurredFollowing property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOccurredFollowing().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ConditionOccurredFollowing }
     * 
     * 
     */
    public List<ConditionOccurredFollowing> getOccurredFollowing() {
        if (occurredFollowing == null) {
            occurredFollowing = new ArrayList<ConditionOccurredFollowing>();
        }
