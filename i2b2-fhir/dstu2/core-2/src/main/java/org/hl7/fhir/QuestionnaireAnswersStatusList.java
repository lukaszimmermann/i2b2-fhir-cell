...
/**
 * <p>Java class for QuestionnaireAnswersStatus-list.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="QuestionnaireAnswersStatus-list">
 ...
 * 
 */
@XmlType(name = "QuestionnaireAnswersStatus-list")
@XmlEnum
public enum QuestionnaireAnswersStatusList {
    ...
    QuestionnaireAnswersStatusList(java.lang.String v) {
        value = v;
    }
    ...
    public static QuestionnaireAnswersStatusList fromValue(java.lang.String v) {
        for (QuestionnaireAnswersStatusList c: QuestionnaireAnswersStatusList.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
