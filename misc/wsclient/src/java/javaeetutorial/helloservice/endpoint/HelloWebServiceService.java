 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://hello1.javaeetutorial/", wsdlLocation = "http://phs000714.local:8080/HelloWorld/HelloWebServiceService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://hello1.javaeetutorial/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://phs000714.local:8080/HelloWorld/HelloWebServiceService?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://hello1.javaeetutorial/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hello1.javaeetutorial/", "HelloWebServicePort"), HelloWebService.class, features);
    }
