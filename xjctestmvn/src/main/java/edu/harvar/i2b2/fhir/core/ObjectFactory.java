 ...
 * generated in the edu.harvar.i2b2.fhir.core package. 
...
public class ObjectFactory {
    ...
    private final static QName _MetaResource_QNAME = new QName("http://i2b2.harvar.edu/fhir/core", "MetaResource");
    private final static QName _MetaResourceSet_QNAME = new QName("http://i2b2.harvar.edu/fhir/core", "MetaResourceSet");
    private final static QName _MetaData_QNAME = new QName("http://i2b2.harvar.edu/fhir/core", "MetaData");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.harvar.i2b2.fhir.core
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://i2b2.harvar.edu/fhir/core", name = "MetaResource")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://i2b2.harvar.edu/fhir/core", name = "MetaResourceSet")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://i2b2.harvar.edu/fhir/core", name = "MetaData")
