...
public class MetaResourceDb {
	...
	public Resource searchResourceById(String id) {
		...
		if (mr!=null) return mr.getResource();
		return null;
	}
	...
	public MetaResourceSet getQueriedMetaResources(Class c, List<String> includeResources) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
